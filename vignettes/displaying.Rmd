...
Example 03_custom_inputs [[source](https://github.com/jcheng5/shinyvalidate/tree/master/inst/examples/03_custom_inputs), live demo TODO] uses a custom input widget to implement a webcam capture input, and uses `setInvalid`/`clearInvalid` methods to overlay the validation message on top of the image preview:
