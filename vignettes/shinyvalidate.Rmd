...
To defer validation until "Submit" or "Continue" time, simply call `iv$enable()` from within whatever `observeEvent` or `eventReactive` is triggered by the submit/continue button. You can see this in the 02\_deferred example **(TODO: provide link to source and live demo)**.
